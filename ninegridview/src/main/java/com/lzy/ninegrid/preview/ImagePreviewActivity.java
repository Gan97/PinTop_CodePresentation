...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    public void LongCilckEvent(LongClickEvent e){
        Log.e(TAG, "LongCilckEvent: 图片网址"+e.getImgUrl() );
        p =new DownPop(getApplicationContext(),e.getImgUrl());
        p.setFocusable(true);
