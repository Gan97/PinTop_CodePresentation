...
public class GuidePhotosAdp2 extends BaseAdapter {
    private Context context;
    private List<PhotosBean.ReturnArrBean> datas;

    public GuidePhotosAdp2(Context context, List<PhotosBean.ReturnArrBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder ;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.guide_photos_item2, null);
