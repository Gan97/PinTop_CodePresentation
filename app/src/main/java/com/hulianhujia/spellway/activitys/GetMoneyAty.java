...
public class GetMoneyAty extends BaseActivity implements YesListener {
    @Bind(R.id.btExit)
    ImageView btExit;
    @Bind(R.id.loTitle)
    ...
    public int getContentId() {
        return R.layout.activity_get_money_aty;
    }
            ...
            case R.id.btCommit:
                if (etClient.getText().toString().length()==0||etClientAg.getText().toString().length()==0||etMoney.getText().toString().length()==0){
                    ...
                    if (etClient.getText().toString().equals(etClientAg.getText().toString())){
                        if (Double.parseDouble(Contents.USER.getAmount())<Double.parseDouble(etMoney.getText().toString())){
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String s) {
                        ...
                        if (bean.getCode()==1){
                            ...
                            String format = df.format((Double.parseDouble(Contents.USER.getAmount())-Double.parseDouble(etMoney.getText().toString())));
