...
public class ChangeWeightAty extends BaseActivity {
    ...
    public int getContentId() {
        return R.layout.changeweight_aty;
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.btSave:
                if (etNick.getText().toString()!=null&&etNick.getText().toString().length()!=0){
                    EventBus.getDefault().post(new ChangeWeightEvent(etNick.getText().toString()));
                    finish();
                }else {
